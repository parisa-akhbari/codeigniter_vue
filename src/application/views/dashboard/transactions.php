                        ...
                        <div class="card-body">
                                <div class="row g-3 align-items-end">
                                        ...
                                        <div class="col-md-3">
                                                ...
                                                <button class="btn btn-secondary" @click="clearFilters">پاک
                                                        کردن</button>
                                        </div>
                                </div>
                        </div>
                                                ...
                                                <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                                ...
                                                                <persian-date-picker
                                                                        ...
                                                                        placeholder="تاریخ تراکنش (شمسی)"></persian-date-picker>
                                                        </div>
                                                </div>
                                        </div>
...
<script src="<?php echo site_url('assets/PersianDatePicker.js') ?>"></script>
...
createApp({
    ...
    methods:{
        ...
        { const res=await fetch("<?= site_url('transactions/api_list_categories') ?>"); const data=await res.json(); this.categories=data.categories||[]; },
